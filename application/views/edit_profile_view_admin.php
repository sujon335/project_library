...
<body>
  ...
  <!-- Start: MAIN CONTENT -->
    ...
    <!-- End: MAIN CONTENT -->
                ...
                <form  method="post" action="<?php echo base_url(); ?>index.php/admin_edit_profile/edit_profile">
                   <fieldset>
          ...
          <div class="span4">
                          ...
                          <div class="widget-body">
                    <div class="center-align">
                   <form  method="post" action="<?php echo base_url(); ?>index.php/admin_edit_profile/change_password">
            <fieldset>
